...
import com.shixun.c13.v3.plant.ChilliPlant;
import com.shixun.c13.v3.plant.PeaPlant;
import com.shixun.c13.v3.plant.PlainPlant;
...
public class GameWorld {
    ...
    public static void main(String [] args) {
        ...
        for(int i = 0; i < 10; i ++) {
            ...
            switch(random) {
                case 0:
                    plant = new ChilliPlant();
                    break;
                case 1:
                    plant = new PeaPlant();
                    break;
                default:
                    plant = new PlainPlant();
                    break;
            }
            //plant.setType("植物-" + i);
            plant.setHp((i + 1) * 10);
        ...
        if(attackPlant instanceof IAttack) {
            while(attackPlant.getHp() > 0 && attackZombies.getHp() > 0) {
                //3. 植物进行防御和攻击.
                ((IAttack)attackPlant).attack(attackZombies);
            ...
            System.out.println("该植物不具备攻击能力，所以游戏结束.....");
        }
